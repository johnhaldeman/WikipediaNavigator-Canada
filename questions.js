...
[
{
	"question": "This Shopping centre includes a waterpark, a habitat for four sea lions, and a hotel. It is the largest mall in North America. Starting at Canada find it's Wikipedia entry in less than four links.",
...
{
	"question": "What is the Canadian Football League equivalent of America's NFL Superbowl? Starting at Canada find it's Wikipedia entry in less than six links.",
...
{
	"question": "During the Second World War and up until 1965, this flag was used as the national flag of Canada. Navigate to it's page in four clicks starting at the Canada page.",
...
{
	"question": "During the War of 1812 between Britain and the US, this US Capital was burned including the the Presidential Mansion, but not before the US burned York (now Toronto) the then capital of Upper Canada. Navigate to the US Capital's page in 6 links from the Canada page.",
...
{
	"question": "This Inuit artist whose works include \"The Enchanted Owl\" and a stained glass window for a chapel at Appleby College in Oakville, Ontario was born on the Southern coast of Baffin Island. She was appointed a Companion of the Order of Canada in 1982. Navigate to her Wikipedia page from the Canada page in 12 links.",
...
{
	"question": "This laywer became the first Prime Minister of Canada. Navigate to his Wikipedia entry from the Canada entry in just two links.",
...
{
	"question": "This site on the on the northernmost tip of Newfoundland was the first Viking settlement in North America to be discovered by archaeologists. Navigate to it's page in just one click.",
...
{
	"question": "This Canadian physician and medical innovator was famously eulogized by Mao Zedong for his service in the Second Sino-Japanese War. He also provided blood transfusion services during the Spanish Civil War and served as a stretcher bearer in France during World War 1. Navigate to his Wikipedia page from the Canada page in 10 links.",
...
{
	"question": "This Scottish Canadian proposed worldwide standard time zones, engineered much of the Intercolonial Railway and the Canadian Pacific Railway, and was a founding member of the Royal Society of Canada. Navigate to his Wikipedia page from the Canada page in four links.",
...
{
	"question": "This festival in Southern Ontario is world renowned for it's production of Shakespearean plays. Navigate to it's page in six links.",
...
{
	"question": "This inventor of the snowmobile also founded a company that went on to become a large multinational aerospace and transportation company. Navigate to his page in four links.",
...
{
	"question": "Part of this Canal, a UNESCO world heritage site, becomes the world's largest naturally frozen ice rink during the winter. Navigate to the Canal's wikipedia page in five links.",
...
{
	"question": "This Canal, part of the St. Lawrence Seaway, connects Lake Erie and Lake Ontario allowing ships to bypass Niagra Falls. Navigate to it's page in six links.",
...
{
	"question": "At the time this question was written, this author of \"Oryx and Crake\" and \"The Handmaid's Tale\" had been awarded 24 honarary degrees including ones from Oxford University, Cambridge University, and the Sorbonne. Navigate to her page in four links",
...
{
	"question": "This treaty ceded most of France's North America territory to Britain and ended the seven years war. Navigate to it's page in four links",
...
{
	"question": "It was after this World War One battle that John McCrae wrote \"In Flanders Fields\". It was the first mass use by Germany of poison gas on the Western Front. There were more than 2,000 Canadian deaths and four Canadians recieved the Victoria Cross after the battle. ",
...
{
	"question": "This group of influential Canadian artists in the 1920's believed that a distinct Canadian art could be developed through direct contact with nature. Emily Carr was closely associated with the group, though was never an official member. Navigate to that group's page in three links.",
...
{
	"question": "In 7 November 1885, this railway was completed - albeit four years later than promised. It's completion was a condition of British Columbia's entry into confederation. Navigate to it's page in less than four links.",
...
{
	"question": "Approximately 2,000 people were killed and injured 9,000 by blast, debris, fires and collapsed buildings in this naval accident. The blast was the largest man-made explosion prior to the development of nuclear weapons. Navigate to it's page in three links.",
...
{
	"question": "This explorer is known for his overland crossing of what is now Canada to reach the Pacific Ocean in 1793 - 12 years before the Lewis and Clark Expedition. Navigate to his page in four links.",
...
{
	"question": "North America's oldest sporting event is cause for a civic holiday in its host city, St. John's. Since the event can be postponed due to adverse weather conditions, the civic holiday date can also change. Navigate to the event's page in five links.",
...
{
	"question": "This city is home to The Big Nickel - a nine-metre (30 ft) replica of a 1951 Canadian nickel. Nickel also plays an important role in the city's economy. Navigate to the city's page in five links.",
...
{
	"question": "John A. McDonald called this the chamber of \"sober second thought\". It's members are appointed by the Governor General on the advice of the Prime Minister. Starting at Canada find it's Wikipedia entry in less than three links.",
...
{
	"question": "This Edmonton born \"Back to the Future\" star was awarded the Order of Canada in 2010. Navigate to his Wikipedia page in eight links from the Canada page.",
...
{
	"question": "This Island, part of Point Pelee National Park, is the southernmost point of land in Canada. Find this Island's Wikipedia entry in ten links or under starting at Canada.",
...
{
	"question": "This company, based out of the largest city in Saskatchewan, is the world's largest producer of a primary crop nutrient used in fertilizer. Navigate to that company's Wikipedia entry from the Canada entry in 5 links",
...
{
	"question": "Canada holds the distinction of participating in the first ever international cricket match and the longest running international sporting competition. Navigate to the location in Manhattan of this first match from the Canada entry in 10 links",
...
{
	"question": "This Canadian Premiere's government introduced the first single-payer, universal health care program. Navigate to his Wikipedia page in six links from the Canada page.",
